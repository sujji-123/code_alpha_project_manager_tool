// src/components/Navbar/MemberNavbar.jsx
  ...
  return (
    <nav className="bg-white shadow p-4 flex justify-between items-center">
      ...
      <div className="flex items-center space-x-4">
        <Link to="/team-member/dashboard" className="hover:underline">Home</Link>
        <Link to="/team-member/my-tasks" className="hover:underline">My Tasks</Link>
