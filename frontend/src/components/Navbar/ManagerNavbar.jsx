  ...
  return (
    <nav className="bg-white shadow p-4 flex justify-between items-center">
      ...
      <div className="flex items-center space-x-4">
        <Link to="/project-manager/dashboard" className="hover:underline text-gray-700">Home</Link>
        <Link to="/project-manager/create-project" className="hover:underline text-gray-700">Create Project</Link>
